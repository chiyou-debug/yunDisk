...
QByteArray Common::getJsonString(QStringList keys, QStringList values)
{
...
// 得到文件或字符串的MD5
QString Common::getMD5(QString info)
{
...
QNetworkAccessManager *Common::getNetWorkManager()
{
